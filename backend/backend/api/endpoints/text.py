...
async def create_text_event(
    ...
    try:
        ...
        if not customer:
            print(f"Debug - Customer not found for domain: {domain}")
        ...
        print(f"Debug - Creating text event: {text_event.__dict__}")  # Debug line
        ...
        print(f"Error in create_text_event: {str(e)}")  # Debug line
        raise
